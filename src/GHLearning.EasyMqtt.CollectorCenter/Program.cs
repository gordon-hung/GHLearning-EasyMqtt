...
using GHLearning.EasyMqtt.CollectorCenter.ReceivedHandles;
...
builder.Services
    .AddEasyMqttClient(
        ...
        .WithClientOptions(
            ...
            .Build())
        .Build())
    .AddEasyMqttTopicReceivedFilter<TemperatureReceivedHandle>(
        new MqttTopicReceivedFilter
        {
    ...
    .AddEasyMqttTopicReceivedFilter<HumidityReceivedHandle>(
        new MqttTopicReceivedFilter
        {
            Topic = "home/humidity/#",
            QualityOfServiceLevel = MqttQualityOfServiceLevel.AtMostOnce
...
// Register the EasyMqtt middleware to handle MQTT messages
app.UseEasyMqtt();
